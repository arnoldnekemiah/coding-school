...
**coding school!** is my test capstone project at Microverse, in this project I follow microverse activity by following github flow, adding required files.
...
- **This repository includes html ,css and Javascript files used to design the website**
...
- Step 2: Once you have installed git you can clone this project using the command below:
  ```
  git clone https://github.com/arnoldnekemiah/coding-school/
  ```
